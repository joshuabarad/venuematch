...
import { searchVenues } from '../../lib/places.js';
import { MapPin, Search, X, Loader, Check, Building2 } from 'lucide-react';

export function VenueSearch({ query, onQueryChange, selected, onToggle, maxSelected = 5 }) {
    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        {searching
          ...
          : query && <button onClick={() => onQueryChange('')} className="absolute right-3 top-3.5 text-muted hover:text-soft"><X size={14} /></button>
        }
        <input type="text" placeholder="Search any NYC venue…"
